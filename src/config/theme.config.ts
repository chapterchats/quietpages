...
export const NAVIGATION = [
  { to: "/", label: "Home" },
  { to: "/categories/book-reviews", label: "Book Reviews" },
  { to: "/blog", label: "Blog" },
...
<script async={true} src="https://subscribe-forms.beehiiv.com/v3/loader.js" data-beehiiv-form="374a06e1-7390-4dfc-bf2d-355dacf473af"></script>
